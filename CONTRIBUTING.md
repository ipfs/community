...
> Report **IPFS abuse** (e.g. using IPFS for the malware hosting, distribution of questionable content, phishing purposes, etc.) to [abuse@ipfs.tech](mailto:abuse@ipfs.tech).
