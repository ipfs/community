...
more_repos+=("ipfs/autobatch,git@github.com:whyrusleeping/autobatch.git")
more_repos+=("ipfs/failstore,git@github.com:whyrusleeping/failstore.git")
more_repos+=("ipfs/retry-datastore,git@github.com:whyrusleeping/retry-datastore.git")
